import { useRef, useLayoutEffect } from 'react'; // Utilisation de useLayoutEffect pour éviter les bugs visuels au chargement
...
export const Hero = () => {
  ...
  // Utilisation de useLayoutEffect au lieu de useEffect pour la stabilité GSAP
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      // Animation Initiale (Timeline)
      const tl = gsap.timeline({ defaults: { ease: 'power3.out' } });

      // On s'assure que les éléments sont visibles au départ si JS plante,
      // mais ici on les cache via GSAP pour l'animation.
      ...
      tl.fromTo(
        ...
        // Correction ici : Sélection directe des enfants pour plus de fiabilité
        .fromTo(
          '.hero-cta-btn', 
      ...
      gsap.to(imageRef.current, {
        y: 200,
        scale: 1.1,
        ease: "none", // Important pour le parallax
        scrollTrigger: {
          trigger: sectionRef.current,
          start: 'top top',
          end: 'bottom top',
          scrub: true, // "true" est plus fluide que "1" parfois
        },
      });
  ...
  return (
    ...
    >
      ...
      <div ref={imageRef} className="absolute inset-0 z-0 opacity-0"> {/* Opacité 0 par défaut pour éviter le flash */}
        ...
        <img
          src={image2}
          alt="Centre Dentaire Al Boughaz Tanger"
      ...
      >
        {/* Tagline */}
        <div ref={taglineRef} className="flex items-center justify-center gap-6 mb-8 lg:mb-8 opacity-0">
        ...
        <h1
          ref={headingRef}
          className="font-serif text-[5.5rem] leading-[1] md:text-7xl lg:text-8xl xl:text-7xl font-bold lg:font-medium text-foreground mb-10 lg:mb-8 lg:leading-tight opacity-0"
        >
...
<br />
        ...
        <p
          ref={subtitleRef}
          className="max-w-4xl mx-auto text-[2.3rem] leading-snug lg:text-xl text-muted-foreground mb-12 lg:mb-12 lg:leading-relaxed font-medium lg:font-normal opacity-0"
        >
...
<br />
        ...
        >
          <a
            href="#contact"
            className="hero-cta-btn block w-5/6 mx-auto lg:inline-flex lg:mx-0 lg:w-auto group relative px-16 py-8 lg:px-8 lg:py-4 bg-gradient-gold text-primary-foreground font-medium overflow-hidden transition-all duration-500 hover:shadow-glow rounded lg:rounded-none opacity-0"
          >
          ...
          <a
            href="#services"
            className="hero-cta-btn block w-4/6 mx-auto lg:inline-flex lg:mx-0 lg:w-auto px-16 py-8 lg:px-8 lg:py-4 border-2 lg:border border-foreground/20 text-foreground font-medium hover:border-primary hover:text-primary transition-all duration-300 rounded lg:rounded-none text-4xl lg:text-base opacity-0"
          >
