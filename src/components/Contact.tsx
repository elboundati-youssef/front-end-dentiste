...
const contactInfo = [
  {
    ...
    label: "Adresse",
    value:
      "Avenue Moulay Youssef, n°69. 3ème étage, Appt 7 (à côté de la Mosquée Badr), Tanger.",
  },
  {
    icon: Phone,
    label: "Téléphone",
...
const features = [
  ...
  },
  {
    ...
    description: "Soins modernes et moins invasifs.",
  },
  {
    icon: Shield,
  ...
  {
    icon: Heart,
    title: "Patient D'abord",
    description: "Votre confort est notre priorité.",
  },
];
