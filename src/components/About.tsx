        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          >
            <div className="relative z-10 image-zoom">
              <img
                src={img2}
                alt="Expertise en blanchiment dentaire de haute qualité au Centre Dentaire Al Boughaz à Tanger, pour un sourire éclatant et une confiance renouvelée"
            ...
            <div className="absolute -bottom-4 -right-4 lg:-bottom-8 lg:-right-8 w-2/3 z-20 shadow-card image-zoom">
              <img
                src={img1}
                alt="Équipe dentaire expérimentée du Dr Amine Khanboubi à Tanger, spécialisée dans les soins dentaires de haute qualité"
          ...
          >
            ...
            <h2 className="font-serif text-5xl lg:text-3xl xl:text-4xl font-bold text-foreground mb-10 leading-tight">
              ...
              <span className="text-gradient">
                une Signature de Soins à Tanger.
              </span>
            </h2>

            <p className="text-muted-foreground text-2xl lg:text-lg mb-12 leading-relaxed font-medium">
              Situé sur l’avenue Moulay Youssef, le Centre Dentaire Al Boughaz{" "}
              <br /> a été conçu comme un sanctuaire dédié à la santé et à
              l’esthétique <br /> de votre sourire. <br /> Notre vision dépasse
              la dentisterie conventionnelle : nous croyons <br />
              en une approche globale où la haute technologie rencontre le
              confort absolu.
            </p>

            <p className="text-muted-foreground text-2xl lg:text-base mb-16 leading-relaxed font-medium">
              Dans un cadre moderne et apaisant, nous avons investi dans les
              dernières innovations numériques (Scanner 3D, Laser) pour garantir
              des diagnostics d'une précision chirurgicale et des traitements
              d'une douceur inégalée.
              <br /> Ici, chaque patient est unique, et chaque sourire est une
              œuvre d'art <br /> que nous protégeons.
            </p>
              ...
              {stats.map((stat, index) => (
                ...
                >
                  ...
                  <div className="w-24 h-24 lg:w-12 lg:h-12 flex items-center justify-center bg-primary/10 text-primary rounded-full shrink-0">
                    ...
                    <stat.icon
                      strokeWidth={2.5}
                      className="w-12 h-12 lg:w-6 lg:h-6 lg:stroke-2"
                    />
                  </div>
